...
class VacationRequestResourceTest extends KernelTestCase
{
    ...
    public function  testVacationModExtensionsRight()
    {
        ...
        $department = DepartmentFactory::createOne();
        $department2 = DepartmentFactory::createOne();
        $department3 = DepartmentFactory::createOne();

        $employee = EmployeeFactory::createOne(['department'=>$department3]);
        $employee2 = EmployeeFactory::createOne(['department'=>$department3]);
        EmployeeFactory::createOne(['department'=>$department3]);

        $employeeMod = EmployeeFactory::createOne(['department'=>$department2, 'employeeExtendedAccesses'=>[]]);
        ...
        $this->browser()
            ...
            ->post('api/employee/department/',[
                'json'=>[
                    ...
                    'departments'=> ['api/departments/'.$department3->getId()],
                ]
            ])
            ->assertStatus(200);
